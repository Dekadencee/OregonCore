...
void LoadDBCStores(const std::string& dataPath)
{
    ...
    if ( !sSpellStore.LookupEntry(53085) || !sSkillLineAbilityStore.LookupEntry(17514) || !sMapStore.LookupEntry(598) ||
		!sGemPropertiesStore.LookupEntry(1127) || !sItemExtendedCostStore.LookupEntry(2425) || !sCharTitlesStore.LookupEntry(71) ||
