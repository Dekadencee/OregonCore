...
protected:
    ...
    bool GetDeletedCharacterInfoList(DeletedInfoList& found_list, std::string search_string = "");
    ...
    void HandleCharacterDeletedListHelper(DeletedInfoList const& found_list);
    void HandleCharacterDeletedRestoreHelper(DeletedInfo const& delete_info);
